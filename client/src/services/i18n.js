...
const DICT = {
  ...
  // booking form — extra labels/messages
  cityPickupRequired: { en: 'City and pickup are required', hi: 'शहर और पिकअप ज़रूरी हैं' },
  signInToBook: { en: 'Sign in to confirm your booking', hi: 'बुकिंग पक्की करने के लिए साइन इन करें' },
  ridersOnlyBook: { en: 'Only riders can book. Log in with a rider account.', hi: 'केवल यात्री बुक कर सकते हैं। यात्री खाते से लॉगिन करें।' },
  enterDestination: { en: 'Please enter your destination', hi: 'कृपया अपना गंतव्य डालें' },
  atLeastOneDay: { en: 'Enter at least 1 day for hire', hi: 'किराए के लिए कम से कम 1 दिन डालें' },
  useMyLocation: { en: 'Use my location', hi: 'मेरी लोकेशन इस्तेमाल करें' },
  locating: { en: 'Locating…', hi: 'लोकेशन ले रहे हैं…' },
  locationOn: { en: 'Location on', hi: 'लोकेशन चालू' },
  locationSet: { en: 'Location set — nearest drivers notified first.', hi: 'लोकेशन सेट — पास के ड्राइवरों को पहले सूचना।' },
  drOp: { en: 'Drop location', hi: 'ड्रॉप स्थान' },
  dropSet: { en: 'Drop set', hi: 'ड्रॉप सेट' },
  approxDistanceKm: { en: 'Approx. distance (km)', hi: 'अनुमानित दूरी (किमी)' },
  optional: { en: 'optional', hi: 'वैकल्पिक' },
  direction: { en: 'Direction', hi: 'दिशा' },
  goingToAirport: { en: 'Going to airport', hi: 'एयरपोर्ट जाना है' },
  comingFromAirport: { en: 'Coming from airport', hi: 'एयरपोर्ट से आना है' },
  airportField: { en: 'Airport', hi: 'एयरपोर्ट' },
  yourPickupFrom: { en: 'Your pickup location (from)', hi: 'आपकी पिकअप जगह (कहाँ से)' },
  yourDropTo: { en: 'Your drop location (to)', hi: 'आपकी ड्रॉप जगह (कहाँ)' },
  tripType: { en: 'Trip type', hi: 'यात्रा प्रकार' },
  numberOfDays: { en: 'Number of days', hi: 'दिनों की संख्या' },
  localPackages: { en: 'Local packages (guide)', hi: 'लोकल पैकेज (गाइड)' },
  paymentMethod: { en: 'Payment', hi: 'भुगतान' },
  cash: { en: 'Cash', hi: 'नकद' },
  upi: { en: 'UPI', hi: 'UPI' },
  ...
  modeAirport: { en: 'Airport transfer', hi: 'एयरपोर्ट ट्रांसफर' },
