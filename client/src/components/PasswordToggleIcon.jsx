...
// of an emoji (🙈/👁️), which renders inconsistently across devices.
// (Same pattern used in ProMedicoz.)
function PasswordToggleIcon({ visible, size = 20 }) {
  return visible ? (
    // Password visible as text -> "eye-slash" (click to hide)
    ...
    // Password masked -> "eye" (click to show)
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
